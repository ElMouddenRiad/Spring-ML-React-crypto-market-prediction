...
public class PortfolioService {
    ...
    public PortfolioService(UserRepository userRepository, PortfolioRepository portfolioRepository, PortfolioItemRepository portfolioItemRepository) {
        ...
        var portfolio = portfolioRepository.findByUserId(user.getId()).stream()
                ...
                .orElseGet(() -> portfolioRepository.findByUserId(user.getId()).stream()
                        ...
                        .orElseGet(() -> {
                            ...
                            newPortfolio.setName("Default Portfolio");
                            newPortfolio.setDescription("Auto-created portfolio for purchases");
                            newPortfolio.setTest(false);
