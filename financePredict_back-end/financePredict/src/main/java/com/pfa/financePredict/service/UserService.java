...
public class UserService implements UserDetailsService {
    ...
    public User saveUser(User user) {
        ...
        if (user.isTestPortfolio()) {
            Portfolio testPortfolio = portfolioRepository.findByUserId(savedUser.getId()).stream()
    ...
    @Transactional
    public Portfolio ensureTestPortfolio(User user, Double initialAmount) {
        Portfolio testPortfolio = portfolioRepository.findByUserId(user.getId()).stream()
                .filter(Portfolio::getTest)
                .findFirst()
                .orElse(null);
        ...
        testPortfolio.setInitialAmount(initialAmount);
        return portfolioRepository.save(testPortfolio);
    }
